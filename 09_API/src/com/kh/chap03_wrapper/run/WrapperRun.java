...
public class WrapperRun {
	...
	public static void main(String[] args) {
		 ...
		 *  	- 메소드를 호출해야 될 때
		 *  	- 메소드의 매개변수로 기본자료형이 아닌 개체타입만이 요구될때
		 *  	- 다형성을 적용시키고 싶을 때
		 * 
		 */
		...
		System.out.println(i1.toString()); // 인티저 클래스에 toString 오버라이딩 돼있음
		System.out.println(i2);
		
		System.out.println(i1 == i2); // 객체화 시켰기 때문에 리터럴값 비교가 아님
		System.out.println(i1.equals(i2)); // 주소값 비교, 찐 값 비교
		...
		// 3. 객체 생성을 통해서 반드시 변환해야되는 경우 => 문자열을 Integer 타입으로
		// Integer i4 = "123";
		...
		// 2. 메소드 따위 사용하지 않고 바로 대입을 하는 방법(AutoUnBoxing)
		int num5 = i1;
