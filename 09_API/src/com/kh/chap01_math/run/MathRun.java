...
public class MathRun {
	...
	public static void main(String[] args) {
		...
		// 올림 : ceil : 크거나 같은 정수값
		double num2 = 4.349;	// 얘보다는 크거나 같은 정수값 => 5
		double num3 = -10.594; 	// 얘보다 크거나 같은 정수값 => -10
		
		System.out.println("올림한 결과 : " + (int)Math.ceil(num2));
		...
		// 제곱 : pow
		System.out.println("2의 10제곱 : " + (int)Math.pow(2, 10));
		
		// Math m = new Math();
		
		/*
		 * * Math의 특징
		 * - 모든 필드가 상수필드, 모든 메소드 static 메소드! (싹 다 static)
